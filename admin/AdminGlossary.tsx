    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full px-4 py-2.5 rounded-lg bg-slate-800 border border-slate-700 text-white text-sm placeholder:text-slate-500 focus:outline-none focus:border-slate-600"
        />
      </div>
              ...
              {editingTerm === item.term && editingItem ? (
                ...
                <div className="space-y-3">
                  <div className="px-3 py-2 rounded-lg bg-slate-800/50 border border-slate-700 text-red-400 text-sm font-black">
                    {item.term}
                    <span className="text-slate-500 text-xs font-normal ml-2">(용어는 수정 불가)</span>
                  </div>
                  <textarea
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-[#112240] rounded-2xl border border-slate-700 w-full max-w-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-400 mb-1">용어 *</label>
                <input
                  type="text"
                  value={newTerm.term}
                ...
                />
                <p className="text-[10px] text-slate-500 mt-1">대소문자를 정확히 입력하세요 (AI ≠ ai)</p>
              </div>

              <div>
                <label className="block text-xs font-bold text-slate-400 mb-1">정의 *</label>
                <textarea
